...
Following the given physical resource constraints, we present the reliable and efficient decomposition and collaboration algorithms based on \emph{IMCL} models to meet the industrial requirements. In particular, we have implemented these algorithms in our tool and get same encouraging results.
